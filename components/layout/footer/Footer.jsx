    ...
    return (<>
        ...
        <footer className="text-white body-font bg-darkblue ">
            <div
                ...
                <div
                    className="md:grid md:justify-start w-full md:grid-cols-3 md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                ...
                <span
                  ...
                  <a
                      href="https://www.linkedin.com/company/monasoftware"
                      className="cursor-pointer hover:opacity-40 text-white "
                  >
                    <svg
                        fill="currentColor"
                        stroke="currentColor"
                    ...
                    <a
                        href="https://www.instagram.com/monasoftwarecom"
                        className="ml-3 cursor-pointer hover:opacity-40 text-white "
                    >
                    <svg
                        fill="none"
