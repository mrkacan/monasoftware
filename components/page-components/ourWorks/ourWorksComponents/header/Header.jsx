...
function Header() {
  return (
    <motion.header className=" pt-[80px] p-4  py-12  text-center bg-darkblue text-white lg:min-h-[800px] h-full shadow-lg">
      <div className="md:flex md:items-center container items-center gap-4 md:mt-24  -mt-12 m-auto">
        <div className="md:order-1 m-auto  mb-4">
          <AboutIcon className="  pt-14   w-full md:w-[338px] m-auto" />
        </div>
