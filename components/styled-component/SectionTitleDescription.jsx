  ...
  return (
    ...
    >
      <div className="container flex flex-col justify-center ">
        <h2 className="text-black text-lg lg:text-2xl pb-8 lg:pb-6 lg:font-semibold">
          {title}
        </h2>
        <h3 className="text-sm text-gray-500 lg:text-lg w-[90%] pb-14 lg:font-light lg:max-w-[60%]">
          {description}
        </h3>
        {children}
      </div>
